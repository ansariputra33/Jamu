          ...
          <div class="card-body">
              ...
              <div class="col-md-12 col-lg-6 col-xl-6">
                <div class="card mb-2 bg-gradient-dark">
                  ...
                  <div class="card-img-overlay d-flex flex-column justify-content-end">
                    <h5 class="card-title text-primary text-white">{{ $d->nama }}</h5>
                    <p class="card-text text-white pb-2 pt-1">{{  $d->deskripsi }}</p>
                    <a href="#" class="text-white">{{ $d->harga}}</a>
                  </div>
                </div>
              </div>
              @endforeach
            ...
            <div class="card-header p-0 pt-1 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                  @php $pages=0; 
                    if(fmod($total,2) == 0){
                      $pages = intdiv($total, 2);
                    }
                    else{
                     $pages = intdiv($total, 2)+1;
                    }
                  @endphp
                  @for($x = 0; $x < $pages; $x++ )
                  <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-three-home-tab" data-toggle="pill" href="#custom-tabs-three-home" role="tab" aria-controls="custom-tabs-three-home" aria-selected="true" onclick="produk_fetch({{ $x*2 }})">{{ $x+1 }}</a>
                  </li>
                  @endfor
                  {{-- 
                  <li class="nav-item">
