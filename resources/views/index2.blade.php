...
<html lang="en">
  ...
  <head>  	
    ...
    <link href="{{asset('pluto/css/bootstrap.min.css')}}" rel="stylesheet">
    <!-- Font Awesome CSS -->
    <link rel="stylesheet" href="{{asset('pluto/fonts/font-awesome.min.css')}}" type="text/css" media="screen">
    <!-- Include roboto.css to use the Roboto web font, material.css to include the theme and ripples.css to style the ripple effect -->
    <link href="{{asset('pluto/css/material.min.css')}}" rel="stylesheet">
    <link href="{{asset('pluto/css/ripples.min.css')}}" rel="stylesheet">
    <link href="{{asset('pluto/css/main.css')}}" rel="stylesheet">
    <link href="{{asset('pluto/css/responsive.css')}}" rel="stylesheet">
    <link href="{{asset('pluto/css/animate.min.css')}}" rel="stylesheet">
  </head>
     ...
     <header class="hero-area" id="home">
      ...
      <div class="container">
        ...
        <div class="contents text-right">
          <h1 class="wow fadeInRight" data-wow-duration="1000ms" data-wow-delay="300ms">Pluto - Material UI Inspired Bootstrap Template</h1>
      ...
      <div class="container">
        ...
        @foreach($produk as $dt => $d)   
          ...
          <div class="col-md-4 col-sm-4 wow fadeInRight" data-wow-duration="1000ms" data-wow-delay="300ms">
            <img src="{{ asset('foto_produk/'.$d->gambar) }}" class="img-responsive" alt="">
          </div>  
        @endforeach
        </div>
    ...
    <section id="features" class="section">
      <div class="container">
        ...
        <div class="row">
          ...
          @foreach($produk as $pd => $d)
          <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="450ms">
            <div class="features">
              <div  style="width:200px; height: 200px;">
                
                <img src="{{ asset('foto_produk/'.$d->gambar) }}">
              </div>
              <div class="features-text">
                <h4>{{ $d->nama }}</h4>
                <p>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6853.31334931688!2d149.5710983929677!3d-33.43399308961885!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0000000000000000%3A0x63680231a1016da2!2sWestern+Region+Academy+of+Sport!5e0!3m2!1sen!2sbd!4v1436826340086" width="100%" height="400" frameborder="0" style="border:0" allowfullscreen></iframe>
    ...
    <script src="{{ asset('pluto/js/jquery-2.1.4.min.js')}}"></script>
    <script src="{{ asset('pluto/js/bootstrap.min.js')}}"></script>
    <script src="{{ asset('pluto/js/ripples.min.js')}}"></script>
    <script src="{{ asset('pluto/js/material.min.js')}}"></script>
    <script src="{{ asset('pluto/js/wow.js')}}"></script>
    <script src="{{ asset('pluto/js/jquery.mmenu.min.all.js')}}"></script> 
    <script src="{{ asset('pluto/js/count-to.js')}}"></script>   
    <script src="{{ asset('pluto/js/jquery.inview.min.js')}}"></script>     
    <script src="{{ asset('pluto/js/main.js')}}"></script>
    <script src="{{ asset('pluto/js/classie.js')}}"></script>
    <script src="{{ asset('pluto/js/jquery.nav.js')}}"></script>      
    <script src="{{ asset('pluto/js/smooth-on-scroll.js')}}"></script>
    <script src="{{ asset('pluto/js/smooth-scroll.js')}}"></script>
